...
source.include_exts = py,png,jpg,kv,atlas,txtset
...
requirements = python3, kivy==2.3.1, kivymd==1.2.0, pyjnius, android, docutils, filetype, pillow, Pygments, requests, coloredlogs, flatbuffers, packaging, numpy, opencv, mpmath, protobuf, sympy, onnxruntime, plyer
...
android.permissions = android.permission.READ_MEDIA_IMAGES, android.permission.INTERNET, android.permission.CAMERA, (name=android.permission.READ_EXTERNAL_STORAGE;maxSdkVersion=32), (name=android.permission.WRITE_EXTERNAL_STORAGE;maxSdkVersion=32)
