...
requirements = python3, kivy==2.3.1, kivymd==1.2.0, pyjnius, android, docutils, filetype, pillow, Pygments, requests, coloredlogs, flatbuffers, packaging, numpy, opencv, mpmath, protobuf, sympy, onnxruntime_gp
